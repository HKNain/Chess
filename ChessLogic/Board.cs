namespace ChessLogic
{
    public class Board
    {
        ...
        public bool InsufficientMaterial()
        {
            ...
            return IsKingVKing(counting) || IsKingBishopVKing(counting) || IsKingBishopVKingBishop(counting) || IsKingKnightVKing(counting);
        }
        ...
        private bool isUnmovdeKingAndRook(Position kingPos, Position rookPos)
        {
        ...
        public bool CastleRightKS(Player player)
        {
            ...
            {
                Player.White => isUnmovdeKingAndRook(new Position(7, 4), new Position(7, 7)),
                Player.Black => isUnmovdeKingAndRook(new Position(0, 4), new Position(0, 7)),
                _ => false
            };
        }
        ...
        public bool CastleRightQS(Player player)
        {
            return player switch
            {
                Player.White => isUnmovdeKingAndRook(new Position(7, 4), new Position(7, 0)),
                Player.Black => isUnmovdeKingAndRook(new Position(0, 4), new Position(0, 0)),
                _ => false
            };
        }
        ...
        {
            Position skipPos = GetPawnSkipPositions(player.Opponent());
